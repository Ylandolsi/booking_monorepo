...
using Booking.Modules.Mentorships.refactored.Domain.Entities.__later;
using Booking.Modules.Mentorships.refactored.Domain.Entities.Availabilities;
using Booking.Modules.Mentorships.refactored.Domain.Entities.Days;
...
using Booking.Modules.Mentorships.refactored.Domain.Entities.Payments;
using Booking.Modules.Mentorships.refactored.Domain.Entities.Sessions;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Diagnostics;

namespace Booking.Modules.Mentorships.refactored.Persistence;
