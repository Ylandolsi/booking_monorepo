...
namespace Booking.Modules.Catalog.Persistence.Migrations
{
    ...
    [Migration("20251011080330_RemoveAdminNotifTable")]
    partial class RemoveAdminNotifTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("StatsProcessedAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.ProductDailyStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_daily_stats");

                    b.HasIndex("Date")
                        .HasDatabaseName("ix_product_daily_stats_date");

                    b.HasIndex("StoreId")
                        .HasDatabaseName("ix_product_daily_stats_store_id");

                    b.HasIndex("ProductId", "Date")
                        .IsUnique()
                        .HasDatabaseName("ix_product_daily_stats_product_id_date");

                    b.ToTable("product_daily_stats", "catalog");
                });

            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Products.Sessions.BookedSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Products.Sessions.SessionAvailability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.StoreDailyStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_store_daily_stats");

                    b.HasIndex("Date")
                        .HasDatabaseName("ix_store_daily_stats_date");

                    b.HasIndex("StoreId", "Date")
                        .IsUnique()
                        .HasDatabaseName("ix_store_daily_stats_store_id_date");

                    b.ToTable("store_daily_stats", "catalog");
                });
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.StoreVisit", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_store_visits");

                    b.ToTable("store_visits", "catalog");
                });
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Products.Sessions.SessionProduct", b =>
                {
                    b.HasBaseType("Booking.Modules.Catalog.Domain.Entities.Products.Product");
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Day", b =>
                {
                    b.HasOne("Booking.Modules.Catalog.Domain.Entities.Products.Sessions.SessionProduct", null)
                        .WithMany("Days")
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Order", b =>
                {
                    b.HasOne("Booking.Modules.Catalog.Domain.Entities.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.ProductDailyStats", b =>
                {
                    b.HasOne("Booking.Modules.Catalog.Domain.Entities.Products.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_daily_stats_products_product_id");
                    ...
                    b.HasOne("Booking.Modules.Catalog.Domain.Entities.Store", "Store")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_daily_stats_stores_store_id");
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Products.Sessions.SessionAvailability", b =>
                {
                    ...
                    b.HasOne("Booking.Modules.Catalog.Domain.Entities.Products.Sessions.SessionProduct", "SessionProduct")
                        .WithMany("Availabilities")
                        .HasForeignKey("SessionProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.StoreDailyStats", b =>
                {
                    b.HasOne("Booking.Modules.Catalog.Domain.Entities.Store", "Store")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_store_daily_stats_stores_store_id");
            ...
            modelBuilder.Entity("Booking.Modules.Catalog.Domain.Entities.Products.Sessions.SessionProduct", b =>
                {
                    b.HasOne("Booking.Modules.Catalog.Domain.Entities.Products.Product", null)
                        .WithOne()
                        .HasForeignKey("Booking.Modules.Catalog.Domain.Entities.Products.Sessions.SessionProduct", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
