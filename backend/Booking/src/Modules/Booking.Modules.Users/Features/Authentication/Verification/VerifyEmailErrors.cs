...
public static class VerifyEmailErrors
{
    ...
    public static Error SendingEmailFailed =>
        Error.Failure("Email.Send.Failed", "Failed to enqueue verification email.");

    public static Error FailedToSaveToken => Error.Failure("Email.VerificationToken.Save.Failed",
        "Failed to save email verification token.");

    public static Error EmailVerificationFailed(string message)
    {
