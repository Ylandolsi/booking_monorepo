        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    konnect_walled_id = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_Bio_Length", "LENGTH(bio) <= 500");
                    table.CheckConstraint("CK_User_Gender_Valid", "gender IS NULL OR gender IN ('Male', 'Female', 'Other', 'Prefer not to say')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_EmailVerificationToken_Dates_Valid", "expires_on_utc > created_on_utc");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RefreshToken_Dates_Valid", "expires_on_utc > created_on_utc");
                    table.CheckConstraint("CK_RefreshToken_Revoked_Valid", "revoked_on_utc IS NULL OR revoked_on_utc >= created_on_utc");
                    table.CheckConstraint("CK_RefreshToken_Token_Length", "LENGTH(token) >= 32 AND LENGTH(token) <= 512");
                    table.ForeignKey(
