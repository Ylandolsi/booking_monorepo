...
export function AddProductFlow({ onComplete, onCancel, className }: AddProductFlowProps) {
  ...
  return (
    <div className={cn('max-w-md mx-auto p-6', className)}>
        ...
        <div className="flex items-center space-x-2 mb-2">
          <div
            className={cn(
              ...
              step === 'type-selection' ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground',
            )}
          >
            1
          </div>
      ...
      {/* Content */}
      {step === 'type-selection' && <ProductTypeSelector onSelect={handleTypeSelect} />}
