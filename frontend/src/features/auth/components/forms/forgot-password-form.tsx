...
import { forgotPasswordInputSchema, type ForgotPasswordInput, AUTH_PLACEHOLDERS } from '@/features/auth';
  ...
  return (
    <>
      <CardDescription className="text-center sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="text-muted-foreground mx-2 mt-2">Enter your email address and we will send you a link to reset your password.</p>
      </CardDescription>
      <CardContent>
        <Form {...form}>
