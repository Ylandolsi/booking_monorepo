...
export const EXPERTISE_OPTIONS = [
  ...
  { value: 'Job Interview Coaching', label: 'Job Interview Coaching' },
  { value: 'Resume & LinkedIn Review', label: 'Resume & LinkedIn Review' },
  ...
  { value: 'Study Abroad Guidance', label: 'Study Abroad Guidance' },
  { value: 'Life Coaching', label: 'Life Coaching' },
  { value: 'Productivity Coaching', label: 'Productivity Coaching' },
] as const;
