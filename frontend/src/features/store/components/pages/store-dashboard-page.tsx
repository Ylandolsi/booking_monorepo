...
import { ProductType, type Product } from '@/features/store/types';
...
export const StoreDashboardPage = () => {
  ...
  // Sample preview data for the mobile preview
  const previewData = {
    formData: {
      title: 'Preview Product',
      subtitle: 'See how your products will look',
      price: 29.99,
      productType: ProductType.Session,
    },
    storeInfo: {
      ...
      slug: mockStore.slug,
      profileImage: mockStore.picture?.url,
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <h1 className="text-2xl font-bold mb-8">Linki Dashboard</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            {mockStore.products && mockStore.products.length > 0 ? (
              <div className="space-y-4">
          ...
          <DialogContent className="sm:max-w-lg">
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="cursor-pointer hover:bg-gray-50" onClick={() => setIsAddProductOpen(false)}>
                  <CardContent className="p-6">
                    <h3 className="font-medium text-lg mb-2">1:1 Call Booking</h3>
                    <p className="text-gray-500">Let clients book time with you for calls or consultations.</p>
                  </CardContent>
                </Card>
                <Card className="cursor-pointer hover:bg-gray-50" onClick={() => setIsAddProductOpen(false)}>
                  <CardContent className="p-6">
                    <h3 className="font-medium text-lg mb-2">Digital Download</h3>
                    <p className="text-gray-500">Sell digital products like e-books, templates, or guides.</p>
                  </CardContent>
                </Card>
              </div>
              <div className="flex justify-end">
                <Button variant="ghost" onClick={() => setIsAddProductOpen(false)}>
                  Cancel
                </Button>
              </div>
            </div>
