...
import {
  ...
  type DayAvailabilityType, useBooking,
...
export function BookingPageDemo() {
  ...
  const daySlots = monthlyAvailabilityQuery.data?.days[selectedDate?.getDate() - 1];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <BookingCalendar
            ...
            disabled={(date) => {
              const pastDaysOfCurrentMonth = (date.getDate() < new Date().getDate() && date.getMonth() == new Date().getMonth());
              const pastMonthsOfCurrentAndPreviousYears = (date.getMonth() < new Date().getMonth()) && date.getFullYear() <= new Date().getFullYear();
              return (pastDaysOfCurrentMonth || pastMonthsOfCurrentAndPreviousYears);

            }}
          />

          {/* Time Slots */}
          {selectedDate && daySlots && (daySlots.timeSlots.map((slot: SessionSlot, index: number) => {
