...
export const ROUTE_GROUPS = {
  ...
  BOOKING: [ROUTE_PATHS.APP.BOOKING.SESSION],

  MENTOR: [ROUTE_PATHS.APP.MENTOR.BECOME, ROUTE_PATHS.APP.MENTOR.SET_SCHEDULE],

  PROFILE: [ROUTE_PATHS.APP.PROFILE.USER],
...
export const PROTECTED_ROUTES = [
  ...
  ROUTE_PATHS.APP.BOOKING.SESSION,
  ROUTE_PATHS.APP.MENTOR.BECOME,
  ROUTE_PATHS.APP.MENTOR.SET_SCHEDULE,
  ROUTE_PATHS.APP.PROFILE.USER,
] as const;
