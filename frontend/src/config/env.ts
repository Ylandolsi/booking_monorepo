...
const createEnv = () => {
    ...
    const envVars = {
        ...
        REFRESH_URL: import.meta.env.VITE_REFRESH_URL || "http://localhost:5000/users/refresh-token",
        ...
        AUTH_SERVICE_URL: import.meta.env.VITE_AUTH_SERVICE_URL || "http://localhost:3000",
    };
