...
export function MeetsPage() {
  ...
  return (
    <div>
      {/* Main Content */}
      <h1 className="mb-2 text-3xl font-bold">Meetings</h1>
      ...
      <div className="mb-8">
        <Label className="block font-semibold">
          ...
          <div className="relative mt-2">
            ...
            {copied && <span className="text-primary absolute top-2 right-12 text-sm">Copied!</span>}
          </div>
        </Label>
      </div>

      {/* Upcoming Meetings */}
      <h2 className="mb-8 text-2xl font-semibold text-gray-900">Upcoming Meetings</h2>
